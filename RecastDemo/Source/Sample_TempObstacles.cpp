							   ...
							   const int maxTiles)
{
	...
	// ͬһ�������������� span �����߶Ȳ�С�� tcfg.walkableClimb ��ʱ����� �� span ���ߣ������� span �� AreaId Ϊ�� span �� AreaId
	if (m_filterLowHangingObstacles)
		rcFilterLowHangingWalkableObstacles(m_ctx, tcfg.walkableClimb, *rc.solid);
	// ����ͻ��
	if (m_filterLedgeSpans)
		rcFilterLedgeSpans(m_ctx, tcfg.walkableHeight, tcfg.walkableClimb, *rc.solid);
	// ���ͬһ������������ span �ļ�϶С�� tcfg.walkableHeight������� span ���Ϊ������
	...
	// �����߶���㼯 -> rc.lset
	// ����ɨ�跽ʽ���������ص������򻮷ֳɲ�ͬ�� layer
	// �ϲ����ص����Ҹ߶Ȳ���� tcfg.walkableHeight ������ͬһ�� layer
	// ���Ѳ��������Ҹ߶Ȳ���� tcfg.walkableHeight �� layer Ҳ�ϲ���ͬһ�� layer
...
bool Sample_TempObstacles::handleBuild()
{
	...
	for (int y = 0; y < th; ++y)
	{
		for (int x = 0; x < tw; ++x)
		{
			...
			// ��� tile �����ÿһ�� layer �����浽һ�� m_tileCache ��
			// ���Զ��� dtTileCache ���ÿһ�� tile ��ʵ����һ�� layer
			for (int i = 0; i < ntiles; ++i)
			{
	...
	// ���������ɿɸ��õ� layer դ�񻯺�����ݣ��Ժ���Ը���
	// ��Ϊդ�� layer �����ʱ�ģ�������Ҫ���������ɣ���̬�����Ķ���ε�ʱ�����ʡ�ܶ�ʱ��
	// dtTileCache �ǽ���������ڴ棬���� cache miss ��ÿ�� tile ͨ����ϣ���������棬�ӿ�����ٶ�
	// ע�⣺ÿ�� layer �ĳ����Ѿ��޳��� borderSize ��

	// Build initial meshes
	// ��� tile ���� layer �ϵĶ���Σ����浽 m_navMesh
