							...
							dtTileRef lastRef, dtTileRef* result)
{
	...
	// Allocate a tile.
    // �� FreeList ���ҳ����е� dtMeshTile
	dtMeshTile* tile = 0;
	if (!lastRef)
	{
        // lastRef �ǿյĻ���ֱ�Ӵ� FreeList ������
		if (m_nextFree)
		{
			tile = m_nextFree;
